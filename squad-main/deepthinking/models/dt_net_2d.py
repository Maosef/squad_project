...
class DTNet(nn.Module):
    ...
    # TODO: change default out channels to 2
    def __init__(self, block, num_blocks, width, in_channels=3, out_channels=3, recall=True, **kwargs):
        super().__init__()
        ...
        #                        stride=1, padding=1, bias=False)
        head_conv3 = nn.Conv2d(8, out_channels, kernel_size=3,
                               stride=1, padding=1, bias=False)
