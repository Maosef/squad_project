...
def train_mse(net, loaders, train_setup, device, disable_tqdm):
    ...
    for batch_idx, (inputs, targets) in enumerate(tqdm(trainloader, leave=False,
        ...
        inputs = inputs.to(torch.float32) # type error otherwise for denoise
        ...
        # print(outputs_max_iters.shape, targets.shape)
