        ...
        with torch.enable_grad(), \
            ...
            for cw_idxs, cc_idxs, qw_idxs, qc_idxs, y1, y2, ids in train_loader:
                ...
                if steps_till_eval <= 0:
                    ...
                    ema.assign(model)
                    results, pred_dict = evaluate_dt(model, dev_loader, device,
                                                  args.dev_eval_file,
                                                  args.max_ans_len,
                                                  args.use_squad_v2,
                                                  args.iterations)
...
def evaluate_dt(model, data_loader, device, eval_file, max_len, use_squad_v2, iterations):
